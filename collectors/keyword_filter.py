...
EGX_KEYWORDS_AR = {
    ...
    'توزيعات', 'أرباح', 'توزيعات أرباح', 'كوبون',
    'استحواذ', 'اندماج', 'تخارج', 'حصص',
    'رأس المال', 'زيادة رأس المال', 'تخفيض رأس',
    ...
    'شركة', 'شركات', 'مساهمة',
    'استثمار', 'استثمارات',
    'توصيات', 'تحليل فني', 'تحليل', 'دعم', 'مقاومة',
    'السوق', 'الأسواق', 'تراجع', 'ارتفاع', 'صعود', 'هبوط',
    'سعر السهم', 'سعر', 'كم سعر',
    'مستويات', 'اختراق', 'كسر',
    'EGX', 'كومي', 'سي أي بي', 'البنك التجاري',
    'هيرميس', 'بالم هيلز', 'طلعت مصطفى',
    'تعليق', 'تداول', 'الإيقاف', 'وقف',
    'محفظة', 'صناديق', 'صندوق',
    'القيمة', 'الربحية', 'مكرر الربحية',
    'قطاع', 'قطاعات', 'البنوك',
    'الذهب', 'الدولار', 'الجنيه',  # مع EGX context only
    'البترولي', 'البترول',
}
